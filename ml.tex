...
\TODO{Show x264 time series adaptation from boggle -- also need to show uncontrolled behavior?}
\figref{classifier-phases-x264} demonstrates the same \bench{x264} application with phased input as shown previously.
