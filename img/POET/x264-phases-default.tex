...
\nextgroupplot[ylabel={\footnotesize Latency \\ {\scriptsize (Normalized)}}, % Performance
...
\addplot[thick, solid, color=s2] table[x index=0,y index=1,col sep=tab] {img/POET/x264-phases-default-clover.txt};
...
\addplot[thick, solid, color=s1] table[x index=0,y index=2,col sep=tab] {img/POET/x264-phases-default-clover.txt};
