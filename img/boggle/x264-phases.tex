...
\addplot[thick, solid, black] coordinates {(0, 0.857) (60, 0.857)}; % 1.8 GHz
...
ymin=0,
ymax=1.1,
xlabel={\footnotesize $time$ [iterations]},
xlabel near ticks,
xtick={0,5,10,15,20,25,30,35,40,45,50,55,60},
...
\addplot[thick, solid, black] coordinates {(0, 1) (60, 1)}; % optimal
