...
\draw
  ...
  node [block, align=center] (featureselection) 
    {Feature\\Selection}
  node [block, right of=featureselection, align=center, node distance=3.1cm] (classifier) 
    {Classifier}
...
\draw (software.west |- feedbackup) -| node [near end,align=center] {PCM\\Sample} (feedbackup);
